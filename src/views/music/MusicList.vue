<template>
  ...
  <div style="width: 100%">
    ...
    <!-- 左边歌单表 -->
    <div style="display:flex;width: 825px">
      <div class="s-l-table">
        <mu-data-table :columns="columns" :data="songList.slice(start, end)" class="s-l-table-content">
  ...
  methods: {
    ...
    search() {
      this.axios({
        ...
        // 问号带参，表单提交
        params: {
          // roleId: data.data.admin.roles[0].roleId,
          field: this.keywords
        },
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded'
